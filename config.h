...
static const char urgbordercolor[]  = "#CF4F88";
static const char clock_fmt[] = "%a %d %b %I:%M %P";
...
/* tagging */
static const char *tags[] = { "web", "sys", "doc", "msg", "vid"};
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-fn", "Ubuntu Mono-12", "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
static const char *termcmd[]  = { "termite", "-e", "tmux", NULL };
static const char *webcmd[] = { "firefox", NULL};
static const char *mailcmd[] = { "termite", "-t", "mutt", "-e", "mutt", NULL };
